...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('msurlfilter_core_path', null, $modx->getOption('core_path') . 'components/msurlfilter/') . 'model/';
            $modx->addPackage('msurlfilter', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/msurlfilter/model/schema/msurlfilter.mysql.schema.xml';
